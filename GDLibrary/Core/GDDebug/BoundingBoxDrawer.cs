...
namespace GDLibrary.Debug
{
    ...
    /// <summary>
    /// Creates the vertices to represent a bounding box which is NOT axis-aligned. Remember MonoGame, by default, can only create axis-aligned bounding boxes. Used by the PhysicsDebugDrawer.
    /// </summary>
